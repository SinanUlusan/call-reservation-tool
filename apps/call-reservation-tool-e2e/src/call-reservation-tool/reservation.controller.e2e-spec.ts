...
import { ReservationController } from '../../../call-reservation-tool/src/modules/reservation/reservation.controller';
import { ReservationService } from '../../../call-reservation-tool/src/modules/reservation/reservation.service';
import { Reservation } from '../../../call-reservation-tool/src/shared/entities/reservation.entity';
import { ReservationStatus } from '../../../call-reservation-tool/src/shared/enums/reservation-status.enum';
import { EmailService } from '../../../call-reservation-tool/src/shared/services/email.service';
import { SmsService } from '../../../call-reservation-tool/src/shared/services/sms.service';
import { PushNotificationService } from '../../../call-reservation-tool/src/shared/services/push-notification.service';
...
describe('ReservationController (e2e)', () => {
  ...
  describe('POST /api/reservation', () => {
    ...
    it('should return 400 for invalid reservation date', async () => {
      const invalidDto = {
        ...createReservationDto,
  ...
  describe('PUT /api/reservation/:id/cancel', () => {
    it('should cancel a reservation successfully', async () => {
      ...
      jest
        ...
        .mockResolvedValue(cancelledReservation as any);
  ...
  describe('PUT /api/reservation/:id/admin-action', () => {
    ...
    it('should reject a reservation', async () => {
      ...
      jest
        .spyOn(reservationService, 'adminAction')
        .mockResolvedValue(rejectedReservation as any);
